...
const improvements: Improvement[] = [
  ...
  id: "home",
  label: "Home",
  title: "Una Home hecha para guiarte a la compra",
  intro:
    "Rediseñamos la página principal para ordenar mejor la web, dar protagonismo al producto y construir un recorrido más claro hacia la compra. Usamos hero con variedad de fotos, productos por relevancia, categorías, FAQ's y apartados creativos.",
  before: "/origenes-home-before.png",
  after: "/origenes-home-after.png",
  changes: [
  ...
  reason:
    "La Home debía funcionar como punto de entrada a la marca y al catálogo. Por eso trabajamos para que cada bloque ayudara a descubrir ORÍGENES, entender su propuesta y avanzar hacia el producto adecuado.",
},
  {
    id: "set",
    label: " Builder Set",
  ...
  {
    id: "look",
    label: "Origenes Looks",
    title: "Etiqueta a Origenes con uno de tus símbolos para aparecer",
    intro:
      "Creamos una experiencia de compra más directa para que el cliente pueda descubrir combinaciones de ORÍGENES y pasar de la inspiración a la compra de sus joyas preferidas con menor fricción, aumentando así el ticket medio.",
    before: "/origenes-look-mobile.mp4",
    after: "/origenes-look-desktop.mp4",
    changes: [
  ...
  },
  {
    ...
    intro:
      "Optimizamos la ficha de producto para presentar mejor cada joya, incrementando la conversión. Para ello, explicamos el producto claramente, aportamos prueba social con reseñas e incitamos a crear su propio set de joyas.",
    before: "/origenes-pdp-before.png",
after: "/origenes-pdp-after.png",
    changes: [
  ...
  },
  {
    ...
    intro:
      "Rediseñamos el carrito para simplificar el proceso de compra, mostrar prueba social e incitar a comprar otros productos, aumentando así el ticket medio. Para ello, usamos una barra de prueba social, la identidad visual de Orígenes y el sistema de cross-sells.",
    before: "",
after: "",
    changes: [
  ...
  },
  {
    ...
    intro:
      "Rediseñamos la página About Us para trasladar la historia, personalidad y propuesta de valor de ORÍGENES a una experiencia más visual, cercana y coherente con el resto del ecosistema digital.",
    before: "/origenes-about-before.png",
    after: "/origenes-about-after.png",
    changes: [
      "Una narrativa más clara alrededor de la marca.",
      "Mayor protagonismo para la historia y personalidad de ORÍGENES.",
      "Una experiencia visual más coherente con el posicionamiento de la marca.",
    ],
    reason:
      "La About Us Page se plantea como una oportunidad para reforzar la conexión con ORÍGENES y transmitir mejor todo lo que representa la marca.",
  },
  {
    id: "email",
    label: "Email Mkt",
    ...
    intro:
      "Creamos una estrategia de captación y comunicación para acompañar al usuario hasta la compra, combinando pop-ups y 11 flujos de emails (entre 1 y 8 emails por flujo) alineados con la identidad de la marca.",
    before: "",
    after: "",
    changes: [
      "Pop-ups adaptados a diferentes momentos y campañas.",
      "Diseños de email alineados con la identidad de ORÍGENES.",
  ...
  },
  {
    ...
    intro:
      "Analizamos cómo comunica ORÍGENES y planteamos una estrategia de contenido y publicidad orientada a mejorar la percepción de marca, generar más impacto y convertir la atención que atraemos en ventas.",
    before: "",
    after: "",
    changes: [
      "Diseños de anuncios estáticos alineados con la identidad de ORÍGENES.",
...
const challengePoints = [
  { number: "1.1", title: "Una web hecha a medida", text: "Había producto, identidad y una propuesta clara, pero su diseño web no transmitía lo mismo." },
  { number: "1.2", title: "Demasiada fricción", text: "El usuario necesitaba muchos pasos para descubrir productos y avanzar hacia la compra." },
  { number: "1.3", title: "De tienda a marca", text: "El reto no era solo rediseñar la web, sino construir una marca capaz de vender y fidelizar." },
];

const strategyPoints = [
  { number: "2.1", title: "Diseño & UX", text: "Reestructuramos la navegación y el diseño para que comprar y gastar más fuese mucho más intuitivo." },
  { number: "2.2", title: "Email Marketing", text: "Mejoramos la estrategia de email para guiar al lead a la venta, reducir el coste de adquisición y aportar una mejor experiencia." },
  { number: "2.3", title: "Estrategia 360º", text: "Trabajamos el ecosistema completo para crear una experiencia coherente: publi, contenido orgánico, pricing y más." },
];

export default function OrigenesCaseStudy() {
          ...
          >
            ...
            >
              ...
              <p
                ...
                "
              >
                Orígenes es una marca de joyas masculina fundada recientemente. Ya estaba vendiendo y tenía una buena gama de joyas. Sin embargo, la web y la estrategia no estaban a la altura. Se lo comenté a Miguel, el fundador, y sin pensarlo dos veces decidimos mejorar ambas.
              </p>
          ...
          <div className="grid gap-14 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
            ...
            <div>
              ...
              <p
                ...
                "
              >
                 ORÍGENES ya contaba con una buena gama de joyas y una propuesta
de marca con potencial. Sin embargo, su presencia digital no
estaba a la altura del producto ni facilitaba a los potenciales clientes la compra. El reto era convertir una
tienda funcional en una experiencia capaz de transmitir valor,
guiar mejor al usuario y generar más oportunidades de compra.
              </p>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="max-w-4xl">
            ...
            <p
              ...
              "
            >
              No queríamos hacer solo una web más bonita. Construimos
una estrategia pensada para que cada parte tuviera una función: atraer, descubrir, convencer y
convertir. Desde la Home y la Product Page hasta el Builder Set, el Email Marketing y el contenido.
            </p>
          ...
          <div className="mt-9">
            <Button
              ...
              "
            >
              Quiero una estrategia así para Orígenes
            </Button>
          </div>
...
{active.id === "set" && (
  <>
    ...
    <div className="group hidden lg:col-span-2 lg:mt-16 lg:block">
      <div className="relative w-full overflow-visible">
        ...
        >
          ...
          <div className="overflow-hidden rounded-[1.25rem] bg-white">
            ...
            <video
              key="set-mobile-desktop"
              src="/origenes-set-mobile.mp4"
              className="block h-auto w-full object-contain"
              muted
              loop
              autoPlay
    ...
    <div className="mt-10 block lg:hidden lg:col-span-2">
      ...
      >
        ...
        <div className="overflow-hidden rounded-[1.05rem] bg-white">
          ...
          <video
            src={
              active.id === "look"
                ? "/origenes-look-desktop.mp4"
                : "/origenes-cart-desktop.mp4"
            }
            className="block h-auto w-full object-contain"
            muted
            loop
      ...
      >
        ...
        <div className="overflow-hidden rounded-[1.25rem] bg-white">
          ...
          <video
            src={
              active.id === "look"
                ? "/origenes-look-mobile.mp4"
                : "/origenes-cart-mobile.mp4"
            }
            className="block h-auto w-full object-contain"
            muted
            loop
...
{/* ===================================================
    ORÍGENESGIRLS / MODAL / CART — MÓVIL
    UN SOLO MOCKUP
=================================================== */}
    ...
    <div className="relative w-full overflow-visible">
      ...
      >
        ...
        >
          ...
          <img
            src="/origenes-about-desktop.png"
            alt="About Us ORÍGENES"
      ...
      >
        ...
        >
          ...
          <img
            src="/origenes-about-mobile.png"
            alt="About Us ORÍGENES móvil"
            className="block h-auto w-full"
          />
      ...
      <div className="lg:col-span-1">
        ...
        <div className="lg:hidden">
          ...
          >
            ...
            <div className="h-[200px] overflow-hidden rounded-[1.05rem] bg-[#777777]">

              <video
  src="/origenes-email-desktop.mp4"
...
/>
  ...
  <img
    src="/origenes-email-1.png"
    alt="Diseño de email marketing de Origenes"
    className="block h-auto w-full object-contain"
  />
...
>
  ...
  <img
    src="/origenes-email-2.png"
    alt="Segundo diseño de email marketing de Origenes"
    className="block h-auto w-full object-contain"
  />
</div>
<div
      ...
      <div className="lg:hidden">
        ...
        >
          ...
          >
            ...
            <video
  src="/origenes-publi-content-desktop.mp4"
  className="block h-auto w-full object-contain"
  muted
  loop
  autoPlay
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="max-w-xl text-base leading-7 text-white/40">
              El trabajo se planteó para que la mejora visual estuviera acompañada de una mejora real de la experiencia de compra, afectando positivamente a la conversión, el ticket medio y la recurrencia.
            </p>
...
<div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
  ...
  {[
    {
      title: "Una marca reconocible",
      text: "La identidad de ORÍGENES pasa a estar presente en cada punto del proceso.",
    },
    {
      title: "Más oportunidades de compra",
      text: "Nuevas experiencias como el Builder Set para gastar más por pedido.",
    },
    {
      title: "Menos fricción, más intención",
      text: "La navegación y el diseño están pensados para llevarte a la decisión.",
    },
    {
      title: "Una marca preparado para crecer",
      text: "De tener piezas aisladas a contar con un ecosistema listo para evolucionar.",
    },
  ].map((item, index) => (
    <div
      key={item.title}

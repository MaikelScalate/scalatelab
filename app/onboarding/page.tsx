...
const handleAccessSubmit = (e: FormEvent<HTMLFormElement>) => {
  ...
  // =====================================================
  // CONTRASEÑA DEL ONBOARDING
  // =====================================================
  const correctPassword = "OnboardingScalateYa";
  ...
  setAccessError("La contraseña no es correcta. Inténtalo de nuevo.");
  setAccessLoading(false);
};
...
function AccessScreen({
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05060b] text-white">
      ...
      <section className="relative z-10 flex min-h-[78vh] items-center justify-center px-5 py-6 sm:px-8 sm:py-8">
        <div className="mx-auto w-full max-w-lg">
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-3 rounded-full border border-white/[0.10] bg-[#05060b]/80 px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.14em] text-white/70 backdrop-blur-sm sm:px-6 sm:py-3 sm:text-sm">
              <span className="relative flex h-2.5 w-2.5 items-center justify-center">
                <span className="absolute h-3 w-3 animate-ping rounded-full bg-purple-400/50" />
                <span className="relative h-1.5 w-1.5 rounded-full bg-gradient-to-r from-[#3B82F6] to-[#D946EF] shadow-[0_0_12px_rgba(217,70,239,0.9)]" />
              </span>
              <span>ONBOARDING</span>
            </div>
          ...
          <div className="mt-5 text-center sm:mt-6">
            <h1 className="text-[2.35rem] font-semibold leading-[1.04] tracking-[-0.055em] sm:text-[2.4rem]">
              Un último paso
              <br />
              antes de empezar.
            </h1>
          ...
          <div className="relative mt-10 rounded-[28px] border border-white/[0.10] bg-[#08090f]/85 p-6 shadow-[0_0_80px_rgba(124,58,237,0.10)] backdrop-blur-xl sm:mt-12 sm:p-8">
            <div className="pointer-events-none absolute left-1/2 top-0 h-32 w-64 -translate-x-1/2 rounded-full bg-purple-600/10 blur-[70px]" />

            <div className="relative">
              <div className="mb-6 flex justify-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-purple-400/20 bg-purple-500/[0.08] text-purple-300 shadow-[0_0_30px_rgba(168,85,247,0.12)]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <form onSubmit={onSubmit} className="mt-5">
                <label htmlFor="onboarding-password" className="mb-2 block text-sm font-medium text-white/70">
                  Contraseña
                </label>
  ...
  setPassword(e.target.value);
                    ...
                    autoComplete="off"
                    disabled={loading}
                    className="h-14 w-full rounded-2xl border border-white/[0.12] bg-white/[0.04] px-5 pr-14 text-base text-white outline-none placeholder:text-white/25 transition-all duration-200 focus:border-purple-400/50 focus:bg-white/[0.06] focus:ring-2 focus:ring-purple-500/10 disabled:cursor-not-allowed disabled:opacity-60"
                  />
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-white/35 transition-colors hover:text-white/70 disabled:pointer-events-none disabled:opacity-50"
                  >
                    {showPassword ? (
                      <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                  ...
                  className="mt-5 flex h-14 w-full items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED] to-[#D946EF] px-6 text-sm font-semibold text-white shadow-[0_0_25px_rgba(217,70,239,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_45px_rgba(217,70,239,0.45)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-[0_0_25px_rgba(217,70,239,0.25)] sm:text-base"
                >
